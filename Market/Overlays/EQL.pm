...
Market::Overlays::EQL - Capa visual que resalta los eventos de Equal Lows
(EQL) detectados por Market::Indicators::Structure sobre el tier "external"
(pivotes swing).

Un EQL ocurre cuando dos pivotes LOW swing consecutivos quedan a una
distancia (en precio) menor o igual que C<eq_threshold * ATR>, indicando un
posible pool de liquidez por igualdad de mínimos.
...
Características visuales (réplica del PineScript LuxAlgo):
  ...
  * Etiqueta "EQL" centrada, ligeramente por debajo de la línea.
...
Dibuja los eventos EQL visibles entre los índices [$start, $end].
